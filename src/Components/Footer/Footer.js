    ...
    return (
        <div className={style.footer_container}>
            ...
            <ul className={style.footer_contact_bar}>
                ...
                <li><img className={style.img} src={_vk} width={40} height={40}/><a href="https://vk.com/n1ce4rt1994" className={style.text}>VK</a></li>
                <li><img className={style.img} src={_instagram} width={40} height={40}/><a href="https://www.instagram.com/n1ce4rt/" className={style.text}>Instagram</a></li>
